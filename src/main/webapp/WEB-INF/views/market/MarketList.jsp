...
<body>
 ...
 <!-- Header -->
  ...
  <main id="main">
   ...
   <a href="${pageContext.request.contextPath }/productWritePage">
          ...
          <div class="col-xl-4 col-md-6">
            <div class="post-item position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                ...
                <span class="post-date">${product.prdate}</span>
          ...
          ${product.prtitle }
                ...
                <div class="meta d-flex align-items-center">
                  <div class="d-flex align-items-center">
                    <i class="bi bi-person"></i> <span class="ps-2">${product.prid }</span>
                  </div>
                  <span class="px-3 text-black-50">/</span>
                  <div class="d-flex align-items-center">
                    <i class="bi bi-folder2"></i> <span class="ps-2">${product.prmoney }원</span>
                  </div>
                </div>
                ...
                <a href="${pageContext.request.contextPath }/productView?viewPrcode=${product.prcode }" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
