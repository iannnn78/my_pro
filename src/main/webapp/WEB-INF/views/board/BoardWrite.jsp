                    ...
                    <div class="col ml-auto mr-auto" style="background-color: white;" >
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">글작성</h1>
                            </div>
                            <hr>
                            <form action="${pageContext.request.contextPath }/boardWrite" 
                                  enctype="multipart/form-data"
                                  method="post" class="user">
                                <%-- <input type="hidden" name="bwriter" value="${sessionScope.loginInfo.mid }">   --%>
                                  
                                <div class="form-group mb-3">
                                    <input name="btitle" type="text" id="inputTitle" placeholder="제목" class="form-control form-control-user">
                                </div>
                                <div class="form-group mb-2">
                                  
                                    <textarea name="bcontents" id="inputContents" class="form-control" rows="10"></textarea>
                                </div>
                                
                                	<div class="form-group mb-4">
							<input type="hidden" >
							 <select  id="inputCate" name ="bcate" class="form-select">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="file" name="bfile" id="inputFile"  class="form-control form-control-user" 
