                        ...
                        <div class="pt-1 px-5 pb-1">
                            ...
                            <hr>
                                ...
                                <div class="form-group ">
                                    <label for="inputBtitle" class="font-weight-bold">글제목</label>
                                    <input name="btitle" readonly="readonly" id="inputBtitle"
                                           value="${board.btitle }"
                                           type="text" id="inputTitle" class="form-control form-control-user">
                                </div>
                                
                                <div class="form-group row">
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                    <label for="inputBId" class="font-weight-bold">작성자</label>
                                        <input type="text" readonly="readonly" id="inputBid"
                                         class="form-control form-control-user" 
                                        value="${board.bid }">   
                                    </div>
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                    <label for="inputBdate" class="font-weight-bold">작성일</label>
                                        <input type="text" readonly="readonly" id="inputBdate"
                                          class="form-control form-control-user" 
                                        value="${board.bdate }"> 
                                    </div>
                                    <div class="col-sm-4">
                                    <label for="inputBviews" class="font-weight-bold">조회수</label>
                                        <input type="text" readonly="readonly" id="inputBviews"
                                        class="form-control form-control-user" 
                                        value="${board.bviews }"> 
                                    </div>                                    
                                </div>                               
                                ...
                                <div class="form-group">
                                    <label for="inputContents" class="font-weight-bold">글내용</label>
                                    <textarea name="bcontents" readonly="readonly" id="inputContents" 
                                    class="form-control" rows="10">${board.bcontents }</textarea>
                                </div>
                                <div class="form-group">
                                	<label for="inputCate" class="font-weight-bold">첨부파일</label>
                                	<img alt="" class="form-control-user img-fluid" width="100"
